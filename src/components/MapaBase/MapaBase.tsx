...
const MapaBase: React.FC<MapaBaseProps> = ({
  ...
  return (
    <div className={cn(
      ...
      {/* Search bar positioned at the top with more margin to avoid controls */}
      {!hideSearchBar && (
        <div className="absolute top-16 left-1/2 transform -translate-x-1/2 z-[1000] w-full max-w-md px-4">
          <SearchBar 
