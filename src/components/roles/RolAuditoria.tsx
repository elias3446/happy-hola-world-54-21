...
export const RolAuditoria: React.FC<RolAuditoriaProps> = ({ rolId }) => {
  ...
  const { data: actividades = [], isLoading: isLoadingActividades } = useQuery({
    queryKey: ['rol-actividades', rolId],
    queryFn: async () => {
      ...
      const actividadesFiltradas = (data as ActividadRol[]).filter(actividad => 
    ...
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2">
          ...
          <span className="truncate">Auditoría del Rol</span>
        </CardTitle>
      </CardHeader>
      <CardContent>
            ...
            <ScrollArea className="h-[300px]">
              {isLoadingActividades ? (
                ...
                <div className="text-center py-8 text-muted-foreground">
                  No se encontraron actividades para este rol
                </div>
              ) : (
          ...
          <TabsContent value="cambios" className="mt-4">
            <ScrollArea className="h-[300px]">
              {isLoadingCambios ? (
                ...
                <div className="text-center py-8 text-muted-foreground">
                  No se encontraron cambios registrados para este rol
                </div>
              ) : (
                <div className="overflow-x-auto">
                  <Table>
