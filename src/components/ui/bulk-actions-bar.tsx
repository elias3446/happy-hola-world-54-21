      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          {showResendConfirmation && onBulkResendConfirmation && (
            <Button variant="outline" size="sm" onClick={onBulkResendConfirmation} disabled={isResendingConfirmation} className="h-8">
          ...
          {showUserActions && (onBulkActivate || onBulkDeactivate || onBulkBlock) && (
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                {onBulkActivate && (
                  <DropdownMenuItem onClick={onBulkActivate} disabled={isActivating} className="text-green-600 hover:text-green-700">
                ...
                {onBulkDeactivate && (
                  <DropdownMenuItem onClick={onBulkDeactivate} disabled={isDeactivating} className="text-orange-600 hover:text-orange-700">
          ...
          {showRoleChange && onBulkChangeRoles && (
            <Button variant="outline" size="sm" onClick={onBulkChangeRoles} disabled={isChangingRoles} className="h-8">
          ...
          {showCategoryChange && onBulkChangeCategory && (
            <Button variant="outline" size="sm" onClick={onBulkChangeCategory} disabled={isChangingCategory} className="h-8">
          ...
          {showEstadoChange && onBulkChangeEstado && (
            <Button variant="outline" size="sm" onClick={onBulkChangeEstado} disabled={isChangingEstado} className="h-8">
          ...
          {showAssignmentChange && onBulkChangeAssignment && (
            <Button variant="outline" size="sm" onClick={onBulkChangeAssignment} disabled={isChangingAssignment} className="h-8">
              <UserCheck className="h-4 w-4" />
          ...
          {showStatusToggle && onBulkToggleStatus && (
            <Button variant="outline" size="sm" onClick={onBulkToggleStatus} disabled={isToggling} className="h-8">
          ...
          {onBulkDelete && (
            <Button variant="destructive" size="sm" onClick={onBulkDelete} disabled={isDeleting} className="h-8">
