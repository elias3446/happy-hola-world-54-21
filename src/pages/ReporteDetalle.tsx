...
export const ReporteDetalle = () => {
  ...
  // Datos para SEO y compartir
  const seoData = reporte ? {
    title: reporte.nombre,
    description: `${reporte.descripcion} - Categoría: ${reporte.categoria?.nombre || 'Sin categoría'}`,
    url: currentUrl,
    image: reporte.imagenes && reporte.imagenes.length > 0 ? reporte.imagenes[0] : undefined
  } : null;
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <SEOHead
          ...
          description="El reporte que buscas no existe o ha sido eliminado."
          url={currentUrl}
        />
        <Card>
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <SocialShareButtons
                  ...
                  hashtags={['reporte', reporte.categoria?.nombre?.toLowerCase().replace(/\s+/g, '') || 'general']}
              ...
              <div className="space-y-2">
                ...
                <div className="p-3 bg-gray-50 rounded-lg space-y-1">
                  ...
                  <p className="text-xs text-gray-600 line-clamp-2">{reporte.descripcion}</p>
